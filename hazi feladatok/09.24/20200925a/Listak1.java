...
class Listak1 {
    ...
    private static List<String> frontX(List<String> words) {
        List<String> rendesSzavak = new ArrayList<String>();
        List<String> xSzavak = new ArrayList<String>();
        for (String s : words) {
            if (s.charAt(0) == 'x') {
                xSzavak.add(s);
            } else {
        ...
        Collections.sort(xSzavak);
        Collections.sort(rendesSzavak);
        xSzavak.addAll(rendesSzavak);
        return xSzavak;
    }
    ...
    public static void main(String[] args) {
        ...
        test(frontX(List.of("bbb", "ccc", "axx", "xzz", "xaa")), List.of("xaa", "xzz", "axx", "bbb", "ccc"));
        test(frontX(List.of("ccc", "bbb", "aaa", "xcc", "xaa")), List.of("xaa", "xcc", "aaa", "bbb", "ccc"));
