...
class Listak2 {
    ...
    private static List<String> listMerge(List<String> li1, List<String> li2) {
        List<String> uj = new ArrayList<String>();
        for (String s : li1) {
            uj.add(s);
        }
        for (String s : li2) {
    ...
    public static void main(String[] args) {
        ...
        test(listMerge(List.of("aa", "xx", "zz"), List.of("bb", "cc")), List.of("aa", "bb", "cc", "xx", "zz"));
        test(listMerge(List.of("aa", "xx"), List.of("bb", "cc", "zz")), List.of("aa", "bb", "cc", "xx", "zz"));
        test(listMerge(List.of("aa", "aa"), List.of("aa", "bb", "bb")), List.of("aa", "aa", "aa", "bb", "bb"));
    }
}
