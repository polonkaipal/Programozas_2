...
namespace Homework
{
    class Sztringek2
    {
        ...
        {
            int notHelye = s.IndexOf("not");
            int badHelye = s.IndexOf("bad");
            if (notHelye < badHelye)
            {
                return s[..notHelye] + "good" + s[(badHelye + 3)..];
            }
        ...
        {
            int aFele = a.Length / 2 + a.Length % 2;
            int bFele = b.Length / 2 + b.Length % 2;
            return a[..aFele] + b[..bFele] + a[aFele..] + b[bFele..];
        }
